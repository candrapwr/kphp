$(function () {
    ...
    $('.datatables-basic').DataTable({
        ajax: $('body').attr('data-asset-path') + 'master/kph_json',
        columns: [{
                data: 'kph_id'
            },
            {
            ...
            },
            {
                ...
                render: function (data, type, full, meta) {
                    return (
                        ...
                        'Details</a>' +
                        '<a href="javascript:void(0);" class="dropdown-item" onClick="hapus(\'' + full['kph_id'] + '\')">' +
...
function simpan() {
    $.ajax({
        url: $('body').attr('data-asset-path') + 'master/kph_json',
        type: 'post',
        dataType: 'json',

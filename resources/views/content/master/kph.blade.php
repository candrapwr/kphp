...
@section('title', 'Master Kesatuan Pengelolaan Hutan (KPH)')
        ...
        <div class="card">
            <div class="card-body">
                ...
                <section id="basic-datatable">
                    ...
                    <div class="modal modal-slide-in fade" id="modals-insert">
                        <div class="modal-dialog sidebar-sm">
                            <form class="add-new-record modal-content pt-0" id="formSimpan">
                                ...
                                <div class="modal-body flex-grow-1">
                                    <div class="mb-1">
                                        <label class="form-label">Nama KPH</label>
                                        <input name="kph_name" type="text" class="form-control"
...
@section('page-script')
{{-- Page js files --}}
<script src="{{ asset('js/master/kph.js') }}"></script>
@endsection

...
Route::group(['prefix' => 'master'], function () {
    Route::get('departemen', [MasterController::class, 'master_departemen'])->name('master-departemen');
    Route::get('jabatan', [MasterController::class, 'master_jabatan'])->name('master-jabatan');
    Route::get('shift', [MasterController::class, 'master_shift'])->name('master-shift');

    Route::get('departemen_json', [MasterController::class, 'master_departemen_json'])->name('master-departemen');
    Route::post('departemen_json', [MasterController::class, 'master_departemen_json'])->name('master-departemen');
});

Route::group(['prefix' => 'karyawan'], function () {
    Route::get('list', [KaryawanController::class, 'karyawan_list'])->name('karyawan-list');
    Route::get('kontrak', [KaryawanController::class, 'karyawan_kontrak'])->name('karyawan-kontrak');
    Route::get('gaji', [KaryawanController::class, 'karyawan_gaji'])->name('karyawan-gaji');
    Route::get('jatahcuti', [KaryawanController::class, 'karyawan_jatahcuti'])->name('karyawan-jatahcuti');
});
/* Route */
